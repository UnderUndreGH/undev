...
- [ ] T009 [BE] Create `devops-app/server/services/ai/system-prompt.ts` — system prompt template with untrusted-context instructions, confidence rubric, tool metadata guidance (prefer reversible, prefer low-danger), and structured output format (Hypothesis/Evidence/Remediation)
